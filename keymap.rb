...
kbd.add_layer :default, %i[
  ...
  LC_SPC   KC_A      KC_S      KC_D      KC_F      KC_G      KC_H      KC_J      KC_K      KC_L      KC_SCOLON KC_QUOT   XXXXXXX   KC_ENT    KC_PGDN
  KC_LSFT   XXXXXXX   KC_Z      KC_X      KC_C      KC_V      KC_B      KC_N      KC_M      KC_COMM   KC_DOT    KC_SLSH   KC_RSFT   XXXXXXX   KC_HOME
  KC_LCTL   KC_LGUI   KC_LALT   XXXXXXX   LNG2_FUNC KC_SPC    KC_SPC    KC_SPC    KC_SPC    KC_RCTL   LNG1_FUNC   KC_LEFT   KC_DOWN   KC_UP     KC_RGHT
]
...
kbd.add_layer :func, %i[
  ...
  KC_CAP   XXXXXXX   XXXXXXX   XXXXXXX   XXXXXXX   XXXXXXX   XXXXXXX   KC_INS    KC_HOME   KC_PGUP   KC_BSPC   XXXXXXX   XXXXXXX   XXXXXXX   KC_PAUSE
